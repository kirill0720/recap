...
source: ~/Downloads/Изучаем DDD. Влад Хононов.pdf
---
...
**[Часть I. Стратегическое проектирование (с. 31)](#часть-i-стратегическое-проектирование-с-31)**

- [Глава 1. Анализ предметной области (с. 33)](#глава-1-анализ-предметной-области-с-33)
- [Глава 2. Экспертные знания о предметной области (с. 50)](#глава-2-экспертные-знания-о-предметной-области-с-50)
- [Глава 3. Как осмыслить сложность предметной области (с. 62)](#глава-3-как-осмыслить-сложность-предметной-области-с-62)
- [Глава 4. Интеграция ограниченных контекстов (с. 77)](#глава-4-интеграция-ограниченных-контекстов-с-77)

**[Часть II. Тактический замысел (с. 89)](#часть-ii-тактический-замысел-с-89)**

- [Глава 5. Реализация простой бизнес-логики (с. 90)](#глава-5-реализация-простой-бизнес-логики-с-90)
- [Глава 6. Проработка сложной бизнес-логики (с. 102)](#глава-6-проработка-сложной-бизнес-логики-с-102)
- [Глава 7. Моделирование фактора времени (с. 125)](#глава-7-моделирование-фактора-времени-с-125)
- [Глава 8. Архитектурные паттерны (с. 144)](#глава-8-архитектурные-паттерны-с-144)
- [Глава 9. Паттерны взаимодействия (с. 164)](#глава-9-паттерны-взаимодействия-с-164)

**[Часть III. Применение DDD на практике (с. 183)](#часть-iii-применение-ddd-на-практике-с-183)**

- [Глава 10. Эвристика проектирования (с. 184)](#глава-10-эвристика-проектирования-с-184)
- [Глава 11. Эволюция проектных решений (с. 194)](#глава-11-эволюция-проектных-решений-с-194)
- [Глава 12. EventStorming (с. 210)](#глава-12-eventstorming-с-210)
- [Глава 13. DDD на практике (с. 224)](#глава-13-ddd-на-практике-с-224)

**[Часть IV. Взаимоотношения с другими методологиями (с. 239)](#часть-iv-взаимоотношения-с-другими-методологиями-с-239)**

- [Глава 14. Микросервисы (с. 240)](#глава-14-микросервисы-с-240)
- [Глава 15. Событийно-ориентированная архитектура (с. 256)](#глава-15-событийно-ориентированная-архитектура-с-256)
- [Глава 16. Сеть данных, Data Mesh (с. 271)](#глава-16-сеть-данных-data-mesh-с-271)

- [Приложение 1. Применение DDD: пример из практики (с. 295)](#приложение-1-применение-ddd-пример-из-практики-с-295)
- [Шпаргалка](#шпаргалка)

# Часть I. Стратегическое проектирование (с. 31)

## Глава 1. Анализ предметной области (с. 33)
...
## Глава 3. Как осмыслить сложность предметной области (с. 62)
...
## Глава 4. Интеграция ограниченных контекстов (с. 77)
...
# Часть II. Тактический замысел (с. 89)

## Глава 5. Реализация простой бизнес-логики (с. 90)
...
## Глава 6. Проработка сложной бизнес-логики (с. 102)
...
## Глава 7. Моделирование фактора времени (с. 125)
...
## Глава 8. Архитектурные паттерны (с. 144)
...
## Глава 9. Паттерны взаимодействия (с. 164)
...
# Часть III. Применение DDD на практике (с. 183)

## Глава 10. Эвристика проектирования (с. 184)
...
## Глава 11. Эволюция проектных решений (с. 194)
...
## Глава 13. DDD на практике (с. 224)
...
# Часть IV. Взаимоотношения с другими методологиями (с. 239)

## Глава 14. Микросервисы (с. 240)
...
## Глава 15. Событийно-ориентированная архитектура (с. 256)
...
## Глава 16. Сеть данных, Data Mesh (с. 271)
...
## Приложение 1. Применение DDD: пример из практики (с. 295)
